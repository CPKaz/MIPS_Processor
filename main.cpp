...
extern void processor_pipeline_loop(Registers &reg_file, Memory &memory, uint32_t end_pc);
...
void print_help()
{
    cout << "Required Options.\n" 
            ...
            "                                         superscalar: A dual-issue out-of-order MIPS processor\n"
...
int main(int argc, char *argv[]) {
    ...
    while (true) {
      ...
      switch (c) {
		  ...
		  processor_pipeline_loop(reg_file, memory, end_pc);
		}
              break;
      }
    }
